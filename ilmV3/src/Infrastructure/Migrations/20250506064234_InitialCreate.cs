        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Absents_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Absents_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Absents_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentGroupMembership", x => new { x.GroupsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_StudentGroupMembership_StudentGroups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "StudentGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentGroupMembership_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Absents_StudentId",
                table: "Absents",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Absents_SubjectId",
                table: "Absents",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Absents_TeacherId",
                table: "Absents",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGroupMembership_StudentsId",
